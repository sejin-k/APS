...
var World = {
    ...
    modelPaths: [
        "assets/models/dog/ball.wt3",
        "assets/models/dog/cap.wt3",
        "assets/models/dog/dog_house.wt3",
        "assets/models/dog/dog_house2.wt3",
        "assets/models/dog/house.wt3"
    ],
    /*
    ...
    */
    ...
    setupEventListeners: function setupEventListenersFn() {
        document.getElementById("tracking-model-button-ball").addEventListener('touchstart', function( /*ev*/ ) {
            World.requestedModel = 0;
        }, false);
        document.getElementById("tracking-model-button-cap").addEventListener('touchstart', function( /*ev*/ ) {
            World.requestedModel = 1;
        }, false);
        document.getElementById("tracking-model-button-dog-house").addEventListener('touchstart', function( /*ev*/ ) {
            World.requestedModel = 2;
        }, false);
        document.getElementById("tracking-model-button-dog-house2").addEventListener('touchstart', function( /*ev*/ ) {
            World.requestedModel = 3;
        }, false);
        document.getElementById("tracking-model-button-house").addEventListener('touchstart', function( /*ev*/ ) {
